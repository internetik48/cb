...
function _1(md){return(
    ...
    export default function defineexp(runtime, observer) {
      const main = runtime.module();
      function toString() { return this.url; }
      const fileAttachments = new Map([
        ["flare.json", {url: new URL("../files/exp.json", import.meta.url), mimeType: "application/json", toString}]
      ]);
      ...
      main.variable().define("partition", ["d3"], _partition);
      main.variable().define("color", ["d3","data"], _color);
      main.variable().define("format", ["d3"], _format);
      main.variable().define("width", _width);
      main.variable().define("radius", ["width"], _radius);
      main.variable().define("arc", ["d3","radius"], _arc);
      return main;
    }
